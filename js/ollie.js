...
(function (global) {
	...
	var DUST_HELD  = 200;  // ★同時に出る数の上限（★溜まり続けないように）
	...
	function drawDusts(part) {
		...
		for (var i = 0; i < st.dusts.length; i++) {
			...
			if (!part && d.kind === 3) continue;         // ★★省略時に星まで出さない
			...
			var dimA = (d.kind === 3) ? STAR_DIM_ALPHA : DUST_DIM_ALPHA;
